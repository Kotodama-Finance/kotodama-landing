...
- **UNA NOTA FECHADA SOBRE EL ESTADO DE UN TERCERO CADUCA SOLA, Y NADA
  ...
  autor) y la de tokiorisk (mismo texto, misma muerte — pendiente). La regla:
